  ...
  { 
   ...
   echo '<a href="indexLogin.php">Logout</a>'; 
                          ...
                          <div class="modal-content regIndx">
                            ...
                            <div class="modal-body">
                              ...
                              <div class="connectBtnModal">
                                <a href="indexLogin.php"><img src="img/btnSocialFb.png" class="btnSocial"></a>
                                <a href="indexLogin.PHP"><img src="img/btnSocialTweet.png" class="btnSocial"></a>
                              ...
                              <form action="" method="post" class="registro" class="modalPost"> 
                                <div><P>Usuario:</P> 
                                  <input type="text" name="usuario" class="lgInput graphicInput"  id="signup-username"></div> 
                                  <div><P>Clave:</P> 
                                    <input type="password" name="password"></div> 
                                    <div><P>Repetir Clave:</P> 
                                      <input type="password" name="repassword" class="smInput graphicInput"></div> 
                                      <div> 
                                        <input type="submit" name="enviar" value="Registrar" class="btnFil modalBtn"></div>
                                      </form> 
                                      <?php 
                    ...
                    { 
                        ...
                        { 
                            ...
                            { 
                                ...
                                $sql = "INSERT INTO user (usuario,password) VALUES ('$usuario','$password')"; 
                                mysql_query($sql); 
          ...
          */
          ...
          //$query = "SELECT * FROM post ";
            ...
            while ($fila = mysql_fetch_array($resultado)) {
              ...
              echo  "<a href='thumbs.html' class='thumbnail'>";
